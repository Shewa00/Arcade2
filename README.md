...
## Итог
>1. Произведен разбор теоретического материала, связанного с созданием игры. 
>>2. Реализована программа с использованием фреймворка Qt5. 
>3. Написаны юнит-тесты, подготовлена документация. 
>>4. Произведена непрерывная сборка проекта на Travis.CI
