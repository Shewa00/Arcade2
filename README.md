...
> :one: Выполнить анализ требований и разработать внешние спецификации;
>> :two: Выполнить проектирование игрового приложения;
...
## Итог :white_check_mark: 
> :one: Произведен разбор теоретического материала, связанного с созданием игры. 

>> :two: Реализована программа с использованием фреймворка Qt5. 

> :three: Написаны юнит-тесты, подготовлена документация. 

>> :four: Произведена непрерывная сборка проекта на Travis.CI

<img width="170" alt="Снимок экрана 2020-02-11 в 2 38 53" src="https://user-images.githubusercontent.com/47750099/74200418-f8f75780-4c77-11ea-8e55-d7d42bec2cef.png">  
